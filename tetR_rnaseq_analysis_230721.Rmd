...
knitr::opts_chunk$set(root.dir = "/dartfs/rc/lab/R/RossB/RobitailleS/rnaseq_230705/")
```
...
cts <- as.matrix(read.table("../../RobitailleS/rnaseq_230705/htseq_counts/all_counts.txt", 
                            sep = "\t", 
                            header = TRUE, 
                            row.names=1, 
                            stringsAsFactors = F))
...
colData <- read.csv("../../RobitailleS/rnaseq_230705/results/tetR_metadata_230721.csv")
head(colData)
...
```{r}
save(dds, file = "../../RobitailleS/rnaseq_230705/results/tetR_DESeq2_230721.rdata")
```
...
```{r}
# save volcano plot
pdf(file = "../../RobitailleS/rnaseq_230705/results/volcano_plot_230712.pdf", width = 11, height = 8.5)
plot(p2)
dev.off()
...
write.csv(as.data.frame(res_ord), file= "../../RobitailleS/rnaseq_230705/results/DE_results_230721.csv")
write.csv(as.data.frame(res_order_FDR_05), file="../../RobitailleS/rnaseq_230705/results/DE_results.FDR.0.05_230721.csv")
```
...
# save plot
pdf(file = "../../RobitailleS/rnaseq_230705/results/DEG_heatmap_230721.pdf", width = 11, height = 8.5)
draw(ht1, row_title = "Genes", column_title = "Hierachical clustering of DEGs (padj<0.05)")
dev.off()
